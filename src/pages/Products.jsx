...
export default function Products() {
  ...
  return (
    <div style={{backgroundColor: "black",width: "100vw",}}>
     ...
     <p style={{textAlign:"left",color:"#FFF8E8",paddingLeft:50}} className='protest-guerrilla-regular productshead'>{collection!=""?collection:"All"}<span style={{fontSize:30}}>{"        "+store}</span></p>
