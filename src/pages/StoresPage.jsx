...
export default function StoresPage() {
  ...
  return (
    ...
    <div className="diagonal-container pcstore">
      ...
      //onClick={()=>navigate(`/product/Store/collection`,{state:{store:"Sticker",collection:""}})}
      >
     <img src={s1} style={{position: "absolute",width: "100vw",bottom:0}}/>
     <div className='hov' style={{zIndex: 1,backgroundColor: "rgba(0,0,0,0.5)",width: "100vw",height: "80vh",justifyContent:"center",alignItems:"center",display:"flex"}}>
        <p style={{fontSize: 100,color:"#FFF8E8"}} className='protest-guerrilla-regular'>COMING SOON</p>
        </div>
      </div>
    ...
    <div>
      ...
      <Button variant='outline' style={{width: "70vw",marginTop: 50,}}
       //onClick={()=>navigate(`/product/Store/collection`,{state:{store:"Sticker",collection:""}})}
       ><img src={sti} style={{objectFit:"cover"}}/><p style={{position: "absolute",backgroundColor:'rgba(0, 0, 0, 0.5)',width: "100%",height:"100%",alignSelf:"center",color:"#FFF8E8",paddingTop:"40%" ,fontSize:20}} className='protest-guerrilla-regular'>COMING SOON</p></Button>
    </div>
    </div>
